...
public:
    ...
    // 4. repeating this at each step we are left with smaller dividend
    // 5. repeat this until dividend becomes lesser than divisor
    // 6. Finally the sum of power of 2s becomes the quotent logically. And we return
    //
